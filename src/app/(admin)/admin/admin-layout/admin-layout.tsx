...
// // import ProductsContent from '@/app/(admin)/admin/products/products';
// // import OrdersContent from '@/app/(admin)/admin/orders/orders';
...
const AdminLayout: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  // Determine active sidebar tab based on URL
